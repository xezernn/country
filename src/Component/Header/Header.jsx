                    ...
                    <div className="mt-6 flow-root">
                        <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="space-y-2 py-6">
                                ...
                                <Link onClick={() => setMobileMenuOpen(false)} rel="noopener noreferrer" to="/Africa" className="flex text-2xl items-center px-4 -mb-1 border-b-2 dark:border-transparent">Africa</Link>

                                <Link onClick={() => setMobileMenuOpen(false)} rel="noopener noreferrer" to="/Europe" className="flex text-2xl items-center px-4 -mb-1 border-b-2 dark:border-transparent">Europe</Link>

                                <Link onClick={() => setMobileMenuOpen(false)} rel="noopener noreferrer" to="/Oceania" className="flex text-2xl items-center px-4 -mb-1 border-b-2 dark:border-transparent">Oceania</Link>
                                <Link onClick={() => setMobileMenuOpen(false)} rel="noopener noreferrer" to="/Asia" className="flex text-2xl items-center px-4 -mb-1 border-b-2 dark:border-transparent">Asia</Link>

                                <Link onClick={() => setMobileMenuOpen(false)} rel="noopener noreferrer" to="/Americas" className="flex text-2xl items-center px-4 -mb-1 border-b-2 dark:border-transparent">Americas</Link>

                                <Link onClick={() => setMobileMenuOpen(false)} rel="noopener noreferrer" to="/Antarctic" className="flex text-2xl items-center px-4 -mb-1 border-b-2 dark:border-transparent">Antarctic</Link>
